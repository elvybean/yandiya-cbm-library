...
#######################################################################################
#from yandiyacbm import ... ALWAYS needs to be below import os and import sys
#######################################################################################
...
def cli_iterate(order: Order, input: list, path: bool):
    packer = Packer()
    ...
    if unfitted != False:
        cli_iterate(order, unfitted, False)
    else:
        return order
